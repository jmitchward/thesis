...
class logistic_regression():
    ...
    def main(self):
        ...
        ML_base.machine_learning.log_reg_accuracy(predictions, self.test_data, self.feature_set[2])
        ML_base.machine_learning.save_instance()
